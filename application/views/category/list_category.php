            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class='form-group'>
                        ...
                        <div class='col-lg-9'>
                            <input type='hidden' name="categoryid" class='form-control' id='category_id'
                ...
                <div class="modal-footer">
                    <button type="button" class="btn dark btn-danger" data-dismiss="modal">Close</button>
