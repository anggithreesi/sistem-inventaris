...
/*
* Menambahkan file pegawais.php di controller
* Cek database pegawai
* controller managepegawai
* buat file manageemploye di pegawai
* copy pegawai list ke manage employe
* hapus dari body
* Menambahkan $data pada fungsi manage pegawai
* Menambahkan fungsi insert
*udh siap cek localhost pegawai
